...
const Home = () => (
  ...
  >
    ...
    <h1 style={{ color: 'white', textAlign: 'center', marginTop: '240px', fontWeight: 700 }} className="secondTitle">
      Freelancing is cool
      </h1>

    <h2 style={{ color: 'white', textAlign: 'center', fontSize: '2rem' }} className="thirdTitle">
